...
class Elbise1Page extends StatefulWidget {

  String elbise1Title;

  Elbise1Page(this.elbise1Title);

  @override
  State<Elbise1Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Elbise1Page> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          header(widget.elbise1Title, context),
                          SizedBox(height: 10),
