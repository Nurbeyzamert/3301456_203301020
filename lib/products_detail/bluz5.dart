...
class Bluz5Page extends StatefulWidget {

  String bluz5Title;

  Bluz5Page(this.bluz5Title);

  @override
  State<Bluz5Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Bluz5Page> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          header(widget.bluz5Title, context),
                          SizedBox(height: 10),
