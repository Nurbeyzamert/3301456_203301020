...
class Elbise3Page extends StatefulWidget {

  String elbise3Title;

  Elbise3Page(this.elbise3Title);

  @override
  State<Elbise3Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Elbise3Page> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          header(widget.elbise3Title, context),
                          SizedBox(height: 10),
