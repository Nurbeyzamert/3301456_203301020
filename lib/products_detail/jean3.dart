...
class Jean3Page extends StatefulWidget {

  String jean3Title;

  Jean3Page(this.jean3Title);

  @override
  State<Jean3Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Jean3Page> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          header(widget.jean3Title, context),
                          SizedBox(height: 10),
