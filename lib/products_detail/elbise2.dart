...
class Elbise2Page extends StatefulWidget {

  String elbise2Title;

  Elbise2Page(this.elbise2Title);

  @override
  State<Elbise2Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Elbise2Page> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          header(widget.elbise2Title, context),
                          SizedBox(height: 10),
