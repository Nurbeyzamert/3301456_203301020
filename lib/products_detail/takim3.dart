...
class Takim3Page extends StatefulWidget {

  String takim3Title;

  Takim3Page(this.takim3Title);

  @override
  State<Takim3Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Takim3Page> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          header(widget.takim3Title, context),
                          SizedBox(height: 10),
