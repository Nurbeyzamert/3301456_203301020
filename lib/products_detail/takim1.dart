...
class Takim1Page extends StatefulWidget {

  String takim1Title;

  Takim1Page(this.takim1Title);

  @override
  State<Takim1Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Takim1Page> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          header(widget.takim1Title, context),
                          SizedBox(height: 10),
