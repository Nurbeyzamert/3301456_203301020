...
class Bluz3Page extends StatefulWidget {

  String bluz3Title;

  Bluz3Page(this.bluz3Title);

  @override
  State<Bluz3Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Bluz3Page> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          header(widget.bluz3Title, context),
                          SizedBox(height: 10),
