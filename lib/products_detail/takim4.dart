...
class Takim4Page extends StatefulWidget {

  String takim4Title;

  Takim4Page(this.takim4Title);

  @override
  State<Takim4Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Takim4Page> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          header(widget.takim4Title, context),
                          SizedBox(height: 10),
