...
class Bluz4Page extends StatefulWidget {

  String bluz4Title;

  Bluz4Page(this.bluz4Title);

  @override
  State<Bluz4Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Bluz4Page> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          header(widget.bluz4Title, context),
                          SizedBox(height: 10),
