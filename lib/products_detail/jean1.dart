...
class Jean1Page extends StatefulWidget {

  String jean1Title;

  Jean1Page(this.jean1Title);

  @override
  State<Jean1Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Jean1Page> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          header(widget.jean1Title, context),
                          SizedBox(height: 10),
