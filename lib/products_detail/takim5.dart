...
class Takim5Page extends StatefulWidget {

  String takim5Title;

  Takim5Page(this.takim5Title);

  @override
  State<Takim5Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Takim5Page> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          header(widget.takim5Title, context),
                          SizedBox(height: 10),
