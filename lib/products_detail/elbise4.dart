...
class Elbise4Page extends StatefulWidget {

  String elbise4Title;

  Elbise4Page(this.elbise4Title);

  @override
  State<Elbise4Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Elbise4Page> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          header(widget.elbise4Title, context),
                          SizedBox(height: 10),
