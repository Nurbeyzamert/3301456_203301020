...
class Pantolon2Page extends StatefulWidget {

  String pantolon2Title;

  Pantolon2Page(this.pantolon2Title);

  @override
  State<Pantolon2Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Pantolon2Page> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          header(widget.pantolon2Title, context),
                          SizedBox(height: 10),
