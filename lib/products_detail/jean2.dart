...
class Jean2Page extends StatefulWidget {

  String jean2Title;

  Jean2Page(this.jean2Title);

  @override
  State<Jean2Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Jean2Page> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          header(widget.jean2Title, context),
                          SizedBox(height: 10),
