...
class Elbise5Page extends StatefulWidget {

  String elbise5Title;

  Elbise5Page(this.elbise5Title);

  @override
  State<Elbise5Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Elbise5Page> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          header(widget.elbise5Title, context),
                          SizedBox(height: 10),
