...
class Pantolon1Page extends StatefulWidget {

  String pantolon1Title;

  Pantolon1Page(this.pantolon1Title);

  @override
  State<Pantolon1Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Pantolon1Page> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          header(widget.pantolon1Title, context),
                          SizedBox(height: 10),
