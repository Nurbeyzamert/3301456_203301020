...
class Takim2Page extends StatefulWidget {

  String takim2Title;

  Takim2Page(this.takim2Title);

  @override
  State<Takim2Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Takim2Page> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          header(widget.takim2Title, context),
                          SizedBox(height: 10),
