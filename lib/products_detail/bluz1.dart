...
class Bluz1Page extends StatefulWidget {

  String bluz1Title;

  Bluz1Page(this.bluz1Title);

  @override
  State<Bluz1Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Bluz1Page> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          header(widget.bluz1Title, context),
                          SizedBox(height: 10),
