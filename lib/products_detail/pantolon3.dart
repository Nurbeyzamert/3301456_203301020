...
class Pantolon3Page extends StatefulWidget {

  String pantolon3Title;

  Pantolon3Page(this.pantolon3Title);

  @override
  State<Pantolon3Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Pantolon3Page> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          header(widget.pantolon3Title, context),
                          SizedBox(height: 10),
